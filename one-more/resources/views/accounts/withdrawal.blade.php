                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-center items-center ">
                        <div class="w-1/3 bg-white shadow-md rounded px-8 pt-6 pb-8">
                            ...
                            <form method="POST" action="/accounts/withdrawal">
                                @csrf

                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="name">Withdrawal from:</label>
                               </div>
                                <div>
                                    <input type="hidden" name ="sender_account_number" value="{{$account->account_number}}">
