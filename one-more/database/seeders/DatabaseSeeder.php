...
//        $user = User::create(
//            [
//                'name' => 'Vitalijs Mikutis',
//                'email' => 'vitalijsmikutis@gmail.com',
//                'password' => bcrypt('123456789'),
//                'google2fa_secret' => 'C4IJT2K6RAYQ4CSP'
//            ]
//        );
//
//        $user = User::create(
...
//        );
        ...
        $currencies = [
            ...
            ['code' => 'CUC', 'name' => 'Cuban Convertible Peso', 'country' => 'Cuba'],
            ...
            ['code' => 'XAF', 'name' => 'Central African CFA Franc', 'country' => 'Central African CFA'],
            ['code' => 'XCD', 'name' => 'East Caribbean Dollar', 'country' => 'Organisation of Eastern Caribbean States'],
            ['code' => 'XOF', 'name' => 'West African CFA franc', 'country' => 'West African Monetary Union'],
